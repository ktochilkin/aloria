...
practiceTask: Открой любой инструмент и выставь лимитную заявку на покупку ниже текущей цены. Увидишь, что она не исполняется сразу, а ждёт встречную в стакане.
