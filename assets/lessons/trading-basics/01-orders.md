...
- Продавец может сказать: *«Продам за 120»*
- Покупатель отвечает: *«Куплю только за 100»*
- Пока цены не совпали — **сделки нет**
...
[
  {
    "question": "Что главное делает биржа?",
    "options": [
      "Назначает справедливую цену активам и публикует её",
      "Сводит заявки покупателей и продавцов и фиксирует сделку, когда цены совпали",
      "Гарантирует, что инвестор получит прибыль"
    ],
    "correctIndex": 1,
    "explanation": "Биржа — это инфраструктура для встречи заявок. Цена не «правильная» и не «справедливая», она просто та, на которой согласились две стороны."
  }
]
