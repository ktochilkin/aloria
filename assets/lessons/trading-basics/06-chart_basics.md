...
- Сделки проходят дороже → линия на графике **поднимается**
- Сделки дешевле → линия **опускается**
...
График удобен тем, что позволяет увидеть рынок не в одном моменте, а в развитии:
...
- На **коротком** промежутке цена может сильно колебаться
- На **длинном** выглядеть более плавно
