...
imageUrl: assets/images/positions.png
...
> Проще говоря, позиция — это ответ на вопрос: _«Что у меня есть прямо сейчас?»_
...
Она формируется _автоматически_ из сделок. Биржа не думает о твоих целях или стратегии — она просто считает результат.
