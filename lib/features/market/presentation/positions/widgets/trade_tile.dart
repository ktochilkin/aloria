...
import 'package:aloria/features/market/presentation/positions/widgets/trade_details_sheet.dart';
...
/// и на какую сумму. Тап открывает шторку с деталями сделки.
class TradeTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => showTradeDetails(context, trade),
